...
import com.feieryuu.picturebackend.api.aliyun.model.GetOutPaintingTaskResponse;
...
import com.feieryuu.picturebackend.manager.auth.annotation.SaSpaceCheckPermission;
import com.feieryuu.picturebackend.manager.auth.model.SpaceUserPermission;
import com.feieryuu.picturebackend.manager.auth.model.SpaceUserPermissionConstant;
...
import com.feieryuu.picturebackend.model.vo.PictureTagCategory;
...
//            }
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        String cacheKey = String.format("feieryuuPicture:listPictureVOByPage:%s",hashKey);
        ...
        // 如果本地缓存 和redis 都没有缓存查询数据库
        Page<Picture> picturePage = pictureService.page(new Page<>(current, size),
                pictureService.getQueryWrapper(pictureQueryRequest));
        Page<PictureVO> pictureVOPage = pictureService.getPictureVOPage(picturePage, request);

        //如果redis 没有缓存 从数据库中查询 然后存入redis
    ...
    public BaseResponse<PictureTagCategory> listPictureTagCategory() {
        ...
        List<String> categoryList = Arrays.asList("壁纸", "头像", "表情包", "素材", "海报");
